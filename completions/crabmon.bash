...
_crabmon() {
    ...
    opts="-r --refresh -s --sort -a --ascending -f --filter -t --tree -l --layout
          --theme --no-color --no-mouse -1 --once --format -n --top -c --config
          -g --group --record --replay --remote --remote-command --serve
          -h --help -V --version"
